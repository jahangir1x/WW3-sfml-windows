#include "LevelBoss1.hpp" // level header file
#include "Puzzle.hpp"
using namespace std;
using namespace sf;

void LevelBoss1::Show(RenderWindow& window, Event& event)
{
	while (LevelHelper::shouldKeepPlaying())
	{
		...
		while (window.isOpen())
		{
			...
			enemy.fireBullet(yuri, 3000, 2500, 350);
			enemy.fireMissile(yuri, 4000, 3500, 325);
