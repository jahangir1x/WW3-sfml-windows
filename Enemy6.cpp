...
void Enemy6::Show(RenderWindow& window)
{
	...
	explosions.erase(remove_if(explosions.begin(), explosions.end(), Enemy6::shouldRemoveExplosion), explosions.end());
