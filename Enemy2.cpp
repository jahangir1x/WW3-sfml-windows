...
void Enemy2::Show(RenderWindow& window)
{
	...
	bulletsLeft.erase(remove_if(bulletsLeft.begin(), bulletsLeft.end(), Enemy2::shouldRemoveBullet), bulletsLeft.end());

	for (auto& bullet : bulletsRight)
	{
		bullet.sprite.move(bullet.velocity * Helper::SecondsPerFrame());
	}
	bulletsRight.erase(remove_if(bulletsRight.begin(), bulletsRight.end(), Enemy2::shouldRemoveBullet), bulletsRight.end());
	...
	missiles.erase(remove_if(missiles.begin(), missiles.end(), Enemy2::shouldRemoveMissile), missiles.end());
	...
	explosions.erase(remove_if(explosions.begin(), explosions.end(), Enemy2::shouldRemoveExplosion), explosions.end());
